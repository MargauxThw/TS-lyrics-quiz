<template>
  <div id="home">
    ...
    <div class="button-menu">
      ...
      <button @click="startPress(8)" class="ttpd">
        The Tortured Poets Department
      </button>
      <button @click="startPress(9)" class="midnights">Midnights</button>
      <button @click="startPress(10)" class="evermore">evermore</button>
      <button @click="startPress(11)" class="folklore">folklore</button>
      <button @click="startPress(12)" class="lover">Lover</button>
      <button @click="startPress(13)" class="reputation">Reputation</button>
      <button @click="startPress(14)" class="nineteen">
        1989 (Taylor's Version)
      </button>
      <button @click="startPress(15)" class="red">
        Red (Taylor's Version)
      </button>
      <button @click="startPress(16)" class="speak">
        Speak now (Taylor's Version)
      </button>
      <button @click="startPress(17)" class="fearless">
        Fearless (Taylor's Version)
      </button>
      <button @click="startPress(18)" class="debut">Debut</button>
      <p>
